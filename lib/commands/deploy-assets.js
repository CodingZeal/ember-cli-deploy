...
module.exports = {
  ...
  availableOptions: [
    ...
    { name: 'file-pattern', type: String, default: '**/*.{js,css,png,gif,jpg}' },
    { name: 'no-cache', type: String, default: '' }
  ],
  ...
  run: function(commandOptions, rawArgs) {
    var options    = {
      ...
      filePattern: commandOptions.filePattern,
      noCache: commandOptions.noCache
    };
    var message;
